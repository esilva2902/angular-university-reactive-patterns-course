 ...
 *    Detection mechanism reflect the new value of NewsletterComponent.firstName property.
 * 
 ...
 *    from the template, Angular verifyies component's changing properties in despite of 
